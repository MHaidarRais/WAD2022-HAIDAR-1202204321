...
if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM showroom_haidar_table WHERE id_mobil=$id";
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/modul3/pages/listCar-haidar.php">Mycar</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form method="post" action="../config/insert.php">
                        ...
                        <a href="../pages/detail-haidar.php?id=<?=$item['id_mobil']?>" class="btn btn-primary px-5">Edit</a>
                    </form>
                </div>
            </div>
        </div>
